...
public class ImageSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.back_view).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mTvAdd = this.findViewById(R.id.add_tv);
        ...
        mTvName = this.findViewById(R.id.title_name_tv);
        mTvName.setText(R.string.image_view);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mTvName.setText(countSelected + " " + getString(R.string.selected));
